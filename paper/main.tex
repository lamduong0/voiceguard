...
Detectors: m1 = \texttt{MelodyMachine/Deepfake-audio-detection-V2}~\cite{melodymachine},
m2 = \texttt{Gustking/wav2vec2-large-xlsr-deepfake}~\cite{gustking}. Evaluation: per-call
...
does not overlap parallel's $[0.451,0.652]$.
...
is LLM-generated and LLM-scored, hence somewhat idealized. We evaluate two detectors, two
datasets, and one language, at modest scale (multi-seed reporting). We study defense only,
